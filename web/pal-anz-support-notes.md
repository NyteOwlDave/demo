...
| `examine`      | `id`           | Load Script Into SCE Editor    |
...
| `input_key`    | `msg, suggest` | Input Key Name with Dialog     |
...
| `scripts`  | `rex` | Inspect Scripts with IDs |
| `size` | `title, w, h` | Inspect Size Metrics |

----------------------------------------------------------------

## Extended `examine` Methods

| Method     | Args  | Purpose |
|------------|-------|------------------------------------|
| `analyzer` |       | Load `analyzer.js` into SCE Editor |
...
| Method     | Args     | Purpose |
|------------|----------|---------------------------------|
| `decode`   | `sender` | Decode Button into JavaScript   |
